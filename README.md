...
# how build calendfi smart contract, compile && deploy it.
...
[Script Code](https://github.com/ActaFi/cardano-staking-smart-contract/blob/master/src/Staking.hs)
...
[Compile code](https://github.com/ActaFi/cardano-staking-smart-contract/blob/master/src/Staking.hs)
...
Then navigate back to the `https://github.com/ActaFi/cardano-staking-smart-contract` and run
...
This writes the hexadecimal bytecode to a file called `Staking.plutus`, this is needed for our next steps.
